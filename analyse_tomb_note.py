...
jieba.load_userdict("F:\浏览器下载\dict.txt")

# 设置相关的文件路径
bg_image_path = "F:\浏览器下载\党.jpg"
text_path = 'F:\浏览器下载\TombNote.txt'
font_path = 'msyh.ttf'
...
def clean_using_stopword(text):
    ...
    with open(stopwords_path,'utf-8') as f_stop:
        f_stop_text = f_stop.read()
        f_stop_text = unicode(f_stop_text, 'utf-8', 'ignore')
